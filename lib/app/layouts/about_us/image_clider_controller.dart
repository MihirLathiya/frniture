...
import 'package:frniture/app/widgets/base_container.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return BaseContainer(
      child: Row(
        ...
        children: [
          (widget.currentPage < 9
                  ? '0${widget.currentPage + 1}'
              ...
              children: [
                ...
                Align(
                  ...
                  child: AnimatedContainer(
                    ...
                    width: (sliderWidth / widget.images.length) *
                        (widget.currentPage + 1),
                    height: 3,
                    decoration: BoxDecoration(
                      color: textPrimary,
